...
\begin{abstract}
  ...
  the analysis from \cite{fxr:Zeileis+Shah+Patnaik:2008}
...
The currencies considered by \cite{fxr:Zeileis+Shah+Patnaik:2008}
...
cny <- fxreturns("CNY", frequency = "daily",
  start = as.Date("2005-07-25"), end = as.Date("2007-12-31"),
...
is clearly smaller than 0, reflecting a slow appreciation of the CNY
...
\bibitem[{Zeileis \emph{et~al.}(2008)Zeileis, Shah, and
  Patnaik}]{fxr:Zeileis+Shah+Patnaik:2008}
Zeileis A, Shah A, Patnaik I (2008).
\newblock \enquote{Testing, Monitoring, and Dating Structural Changes
  in Maximum Likelihood Models.}
\newblock \emph{Report~70}, Department of Statistics and Mathematics,
  Wirtschaftsuniversit\"at Wien, Research Report Series.
